 ...
 *   "damage": 4,
 *   "lifetime": 100,
 *   "circle": "youkaishomecoming:test_spell_0",
 *   "origin": { "mode": "caster" },
 *   "velocity_x": 0,
 *   "velocity_y": 0,
 *   "velocity_z": 0.5,
...
public record SpawnShooterAction(
	...
	public SpawnShooterAction(
		...
		this(health, damage, lifetime, ShooterData.DEFAULT_CIRCLE, origin, velocityX, velocityY, velocityZ,
	...
	public SpawnShooterAction withBody(List<SpellAction> body) {
		return new SpawnShooterAction(health, damage, lifetime, circle, origin, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withHealth(int v) {
		return new SpawnShooterAction(v, damage, lifetime, circle, origin, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withDamage(float v) {
		return new SpawnShooterAction(health, v, lifetime, circle, origin, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withLifetime(int v) {
		return new SpawnShooterAction(health, damage, v, circle, origin, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withCircle(ResourceLocation v) {
		return new SpawnShooterAction(health, damage, lifetime, v, origin, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withOrigin(OriginConfig v) {
		return new SpawnShooterAction(health, damage, lifetime, circle, v, velocityX, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withVelocityX(NumberProvider v) {
		return new SpawnShooterAction(health, damage, lifetime, circle, origin, v, velocityY, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withVelocityY(NumberProvider v) {
		return new SpawnShooterAction(health, damage, lifetime, circle, origin, velocityX, v, velocityZ,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public SpawnShooterAction withVelocityZ(NumberProvider v) {
		return new SpawnShooterAction(health, damage, lifetime, circle, origin, velocityX, velocityY, v,
				count, speed, angleOffset, spread, elevation, pattern, aimMode,
				outerCount, tiltAngle, groupRotation, mover,
				ysmModel, ysmTexture, ysmAnimation, ysmDuration, ysmClearTarget, body);
	}
	...
	public void execute(SpellContext ctx) {
		...
		if (usesPatternEmitter()) {
			...
			PatternEmitter.emit(ctx, patternSpawnPos, settings, (vel, baseDir, spawnIndex) ->
