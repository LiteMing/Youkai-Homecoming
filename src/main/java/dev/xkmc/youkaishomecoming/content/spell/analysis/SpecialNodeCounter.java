...
public final class SpecialNodeCounter {
	...
	private static SpellCapability directCapability(SpellAction action) {
		...
		if (action instanceof SetInvulnerableAction) return SpellCapability.SET_INVULNERABLE;
		if (action instanceof FreezeOnTickAction) return SpellCapability.FREEZE_ON_TICK;
