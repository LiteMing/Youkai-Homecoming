...
public enum SpellCardRank implements StringRepresentable {
	...
	public SpellDraftBudget createBudget() {
		...
		return new SpellDraftBudget(
				...
				settings.experimentalGrant(SpellCapability.EXPERIMENTAL_FIRE),
				settings.experimentalGrant(SpellCapability.ORIGIN_TARGET),
				settings.experimentalGrant(SpellCapability.LONG_LIFETIME),
				settings.experimentalGrant(SpellCapability.TARGET_COORDINATE),
				settings.experimentalGrant(SpellCapability.TRACKING_MOVER),
				0
		);
	}
