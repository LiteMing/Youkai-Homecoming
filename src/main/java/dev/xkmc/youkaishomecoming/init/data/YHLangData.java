...
public enum YHLangData {
	...
	private static final Map<String, String> CONFIG_EN = Map.ofEntries(
			...
			Map.entry("config.youkaishomecoming.client.classicControlAscendKey.tooltip", "Minecraft key name used to jump or ascend, for example key.keyboard.right.control"),
			Map.entry("config.youkaishomecoming.client.classicControlDescendKey", "Classic Descend Key"),
			Map.entry("config.youkaishomecoming.client.classicControlDescendKey.tooltip", "Minecraft key name used to sneak or descend, for example key.keyboard.right.shift"),
