...
public enum YHLangData {
	...
	CLASSIC_CONTROL_ENABLED("message.classic_control.enabled", "Classic controls enabled; movement and toggle keys follow client config", 0, ChatFormatting.AQUA),
	CLASSIC_CONTROL_DISABLED("message.classic_control.disabled", "Classic controls disabled; use the configured focus + toggle keys to enter", 0, ChatFormatting.YELLOW),
	CLASSIC_CONTROL_AVAILABLE("message.classic_control.available", "Use the configured focus + toggle keys to enter classic controls", 0, ChatFormatting.AQUA),
