...
public enum YHLangData {
	...
	CERT_QUOTE_INVALID_HEALTH_PLAN("cert.quote_reason.invalid_health_plan", "The spellcard_init health, timeout, or completion chain is invalid", 0, null),
	...
	STG_NEED_SPELL("message.stg_need_spell", "You need a complete, unbroken spell card to enter danmaku combat", 0, ChatFormatting.RED),
	...
	CLASSIC_CONTROL_STATUS_MODERN("message.classic_control.status.modern", "Modern control mode", 0, ChatFormatting.GOLD),
	...
	AUTO_DODGE_STATUS_GUIDED("message.auto_dodge.status.guided", "Control assist: %s", 1, ChatFormatting.YELLOW),
	AUTO_DODGE_DIRECTION_UP("message.auto_dodge.direction.up", "Up", 0, null),
	AUTO_DODGE_DIRECTION_DOWN("message.auto_dodge.direction.down", "Down", 0, null),
	AUTO_DODGE_DIRECTION_LEFT("message.auto_dodge.direction.left", "Left", 0, null),
	AUTO_DODGE_DIRECTION_RIGHT("message.auto_dodge.direction.right", "Right", 0, null),
	AUTO_DODGE_DIRECTION_FORWARD("message.auto_dodge.direction.forward", "Forward", 0, null),
	AUTO_DODGE_DIRECTION_BACKWARD("message.auto_dodge.direction.backward", "Backward", 0, null),
	...
	STG_TOGGLE_TIP("tooltip.stg_toggle", "Shift + Right Click: enter or leave danmaku combat (entry costs no XP)", 0, ChatFormatting.DARK_AQUA),
	STG_TOGGLE_KEY_TIP("tooltip.stg_toggle_key", "%s + %s: enter or leave danmaku combat (entry costs no XP)", 2, ChatFormatting.DARK_AQUA),
	...
	SPELL_PERMISSION_LIMITED("tooltip.spell_permission_limited", "Your spell permission is insufficient: unavailable nodes and hooks are skipped", 0, ChatFormatting.YELLOW),
	SPELL_PERMISSION_FORBIDDEN("tooltip.spell_permission_forbidden", "Spell permission 0 (forbid): spell cards and non-spells are disabled", 0, ChatFormatting.RED),
	SPELL_PERMISSION_UNLOCKED("message.spell_permission_unlocked", "Spell permission unlocked: %s", 1, ChatFormatting.GREEN),
	...
	NON_SPELL_REASON_GENERIC("tooltip.non_spell_reason_generic", "The spell failed the shared spell structure or performance checks", 0, null),
	NON_SPELL_REASON_DEFINITION("tooltip.non_spell_reason_definition", "The bound spell definition is missing", 0, null),
	NON_SPELL_REASON_INITIALIZATION("tooltip.non_spell_reason_initialization", "Non-spells cannot use spellcard_init", 0, null),
	NON_SPELL_REASON_LIFETIME("tooltip.non_spell_reason_lifetime", "Projectile or shooter lifetime exceeds the shared spell limit", 0, null),
	NON_SPELL_REASON_SHOOTER("tooltip.non_spell_reason_shooter", "The shooter count exceeds the shared spell budget", 0, null),
	NON_SPELL_REASON_BUDGET("tooltip.non_spell_reason_budget", "The spell exceeds its Power-based spawn-per-tick limit or the shared performance budget", 0, null),
	NON_SPELL_REASON_STRUCTURE("tooltip.non_spell_reason_structure", "The spell has invalid or unbounded phases, nesting, repeats, actions, or expressions", 0, null),
	...
	private static final Map<String, String> CONFIG_EN = Map.ofEntries(
			...
			Map.entry("config.youkaishomecoming.client.hud", "HUD"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell", "Active Spell HUD"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.enabled", "Show Active Spell HUD"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.enabled.tooltip", "Show initialized spell cards after show_spell_title runs"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.xAnchor", "Horizontal Anchor"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.xAnchor.tooltip", "Horizontal anchor (-1=left, 0=center, 1=right)"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.xOffset", "Horizontal Offset"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.xOffset.tooltip", "Horizontal pixel offset from the anchor"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.yAnchor", "Vertical Anchor"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.yAnchor.tooltip", "Vertical anchor (-1=top, 0=center, 1=bottom)"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.yOffset", "Vertical Offset"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.yOffset.tooltip", "Vertical pixel offset from the anchor"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.scale", "Font Scale"),
			Map.entry("config.youkaishomecoming.client.hud.active_spell.scale.tooltip", "Scale of active spell text and its background"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status", "Combat Status HUD"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.enabled", "Show Combat Status HUD"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.enabled.tooltip", "Show Auto Dodge and control mode status"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.xAnchor", "Horizontal Anchor"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.xAnchor.tooltip", "Horizontal anchor (-1=left, 0=center, 1=right)"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.xOffset", "Horizontal Offset"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.xOffset.tooltip", "Horizontal pixel offset from the anchor"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.yAnchor", "Vertical Anchor"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.yAnchor.tooltip", "Vertical anchor (-1=top, 0=center, 1=bottom)"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.yOffset", "Vertical Offset"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.yOffset.tooltip", "Vertical pixel offset from the anchor"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.scale", "Font Scale"),
			Map.entry("config.youkaishomecoming.client.hud.combat_status.scale.tooltip", "Scale of combat status text and its background"),
			Map.entry("config.youkaishomecoming.client.keys", "Keys"),
			Map.entry("config.youkaishomecoming.client.danmakuCombatModifierKey", "Danmaku Combat Modifier Key"),
			Map.entry("config.youkaishomecoming.client.danmakuCombatModifierKey.tooltip", "Hold this key with the combat toggle key to enter or leave manual danmaku combat. Default: key.keyboard.left.shift"),
			Map.entry("config.youkaishomecoming.client.danmakuCombatToggleKey", "Danmaku Combat Toggle Key"),
			Map.entry("config.youkaishomecoming.client.danmakuCombatToggleKey.tooltip", "Press this key with the combat modifier key. Entering requires a cast-ready spell card in the hands, inventory, or Curios. Default: key.keyboard.f"),
			Map.entry("config.youkaishomecoming.client.autoDodgePilotControlKey", "Auto Dodge Pilot Assist Key"),
			Map.entry("config.youkaishomecoming.client.autoDodgePilotControlKey.tooltip", "Minecraft key name used for assisted pilot control, for example key.keyboard.left.control"),
			Map.entry("config.youkaishomecoming.client.classicControlForwardKey", "Classic Move Forward Key"),
			Map.entry("config.youkaishomecoming.client.classicControlForwardKey.tooltip", "Minecraft key name used to move forward, for example key.keyboard.up"),
			Map.entry("config.youkaishomecoming.client.classicControlBackwardKey", "Classic Move Backward Key"),
			Map.entry("config.youkaishomecoming.client.classicControlBackwardKey.tooltip", "Minecraft key name used to move backward, for example key.keyboard.down"),
			Map.entry("config.youkaishomecoming.client.classicControlLeftKey", "Classic Move Left Key"),
			Map.entry("config.youkaishomecoming.client.classicControlLeftKey.tooltip", "Minecraft key name used to move left, for example key.keyboard.left"),
			Map.entry("config.youkaishomecoming.client.classicControlRightKey", "Classic Move Right Key"),
			Map.entry("config.youkaishomecoming.client.classicControlRightKey.tooltip", "Minecraft key name used to move right, for example key.keyboard.right"),
			Map.entry("config.youkaishomecoming.client.classicControlAscendKey", "Classic Ascend Key"),
			Map.entry("config.youkaishomecoming.client.classicControlAscendKey.tooltip", "Minecraft key name used to jump or ascend, for example key.keyboard.right.shift"),
			Map.entry("config.youkaishomecoming.client.classicControlDescendKey", "Classic Descend Key"),
			Map.entry("config.youkaishomecoming.client.classicControlDescendKey.tooltip", "Minecraft key name used to sneak or descend, for example key.keyboard.right.control"),
			Map.entry("config.youkaishomecoming.client.classicControlFocusKey", "Classic Focus Key"),
			Map.entry("config.youkaishomecoming.client.classicControlFocusKey.tooltip", "Minecraft key name used for low-speed focus, for example key.keyboard.left.shift"),
			Map.entry("config.youkaishomecoming.client.classicControlToggleKey", "Classic Mode Toggle Key"),
			Map.entry("config.youkaishomecoming.client.classicControlToggleKey.tooltip", "Minecraft key name combined with the focus key to toggle classic controls"),
			Map.entry("config.youkaishomecoming.client.classicControlNonSpellKey", "Classic Non-spell Key"),
			Map.entry("config.youkaishomecoming.client.classicControlNonSpellKey.tooltip", "Minecraft key name used to hold-fire a non-spell in classic controls, for example key.keyboard.z"),
			Map.entry("config.youkaishomecoming.client.classicControlNextSpellKey", "Classic Next Spell Key"),
			Map.entry("config.youkaishomecoming.client.classicControlNextSpellKey.tooltip", "Minecraft key name used to cast the next spell in classic controls, for example key.keyboard.x"),
			Map.entry("config.youkaishomecoming.client.classicControlLowSpeedMultiplier", "Classic Controls Low-speed Multiplier"),
			Map.entry("config.youkaishomecoming.client.classicControlLowSpeedMultiplier.tooltip", "Fraction of vanilla sprint speed while holding the configured focus key (0.00-1.00)"),
			...
			Map.entry("config.youkaishomecoming.common.auto_dodge.controlWeight", "Control Assist Weight"),
			Map.entry("config.youkaishomecoming.common.auto_dodge.controlWeight.tooltip", "Weight of Control-assisted movement relative to automatic navigation and anchor return"),
