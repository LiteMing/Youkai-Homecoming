...
public enum YHFood implements ItemLike {
	...
	ROASTED_LAMPREY_FILLET(FoodType.FAST, 6, 0.8f,
			...
			YHTagGen.COOKED_EEL, YHTagGen.CABBAGE_ROLL_INGREDIENTS, DietTagGen.PROTEINS.tag
	),
	...
	RAW_TUNA_SLICE(FoodType.FAST, 4, 0.3f,
			...
			YHTagGen.RAW_TUNA, YHTagGen.CABBAGE_ROLL_INGREDIENTS, DietTagGen.PROTEINS.tag
	),
	SEARED_TUNA_SLICE(FoodType.FAST, 5, 0.8f,
			new EffectEntry(() -> MobEffects.DOLPHINS_GRACE, 400, 0, 0.4f),
			YHTagGen.COOKED_TUNA, YHTagGen.CABBAGE_ROLL_INGREDIENTS, DietTagGen.PROTEINS.tag
	),
	...
	GRILLED_VENISON_SLICE(FoodType.FAST, 6, 0.8f,
			YHTagGen.COOKED_VENISON, YHTagGen.CABBAGE_ROLL_INGREDIENTS, DietTagGen.PROTEINS.tag
	),
